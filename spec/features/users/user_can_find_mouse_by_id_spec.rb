...
describe "as an authenticated user" do
  ...
  context "I can search for a mouse by its original id" do
    ...
    it "and see all relevant information about a mouse" do
      ...
      expect(page).to have_content("#{mouse.trisomic}")
      expect(page).to have_content("#{mouse.protein_ug_per_ml}")
      expect(page).to have_content("#{mouse.diet}")
      expect(page).to have_content("#{mouse.color}")
      expect(page).to have_content("#{mouse.sex}")
      ...
      expect(page).to have_content("#{mouse.status}")
    end
